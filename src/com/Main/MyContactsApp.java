...
public class MyContactsApp {
	    ...
	    public static void deleteAllContacts() {
	        ...
	        if (confirm.equalsIgnoreCase("y")) {
	            ...
	            System.out.println("System: All contacts have been deleted.");
	        } else {
	    ...
	    public static boolean displayMenu() {
	        if (activeClient == null) {
	            ...
	            System.out.println("1. Profile 2. Settings 3. Add Contact 4. View Contacts 5. Edit Contact 6. Delete Contact 7. Wipe All Contacts 0. Log Out");
	            System.out.print("Choice: ");
